  ...
  return (
    <main className="flex min-h-screen w-full flex-col bg-white ">
      ...
      <body className="mb-40 mt-10">
        ...
        <div className=" relative z-10 ml-auto mr-auto mt-10 flex  w-10/12 grid-cols-3  flex-col items-center justify-center gap-y-6 xl:mt-16 xl:grid xl:w-9/12 xl:gap-x-20">
          {blogLoading ? (
            <>
              <BlogCardLoading />
              <BlogCardLoading />
